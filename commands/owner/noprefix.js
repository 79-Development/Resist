...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const guide = new MessageEmbed()
      ...
      .addField(`<a:arrow_right:1133392521297399960> ${prefix}noprefix add <user> all`, `Add a user to noprefix users for all servers.`)
      .addField(`<a:arrow_right:1133392521297399960> ${prefix}noprefix remove <user> all`, `Remove a user from noprefix users from all servers.`)
      .addField(`<a:arrow_right:1133392521297399960> ${prefix}noprefix show`, `Shows all the users in noprefix database.`)
      .addField(`<a:arrow_right:1133392521297399960> ${prefix}noprefix reset`, `Removes all the users from noprefix users from the database.`)
